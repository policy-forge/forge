...
| 1.9 | 2026-09-12 | Codex | Recorded the implemented (unmerged) PRD-066 Phase 1 local-only `forge suggest` pipeline: nine closed contracts, the owner's local-only/corpus-first decisions, and GATE-SUGGEST rows whose usefulness and release gates stay open. PRD-066 stays Planned. |
