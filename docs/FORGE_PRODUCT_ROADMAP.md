...
| 1.7 | 2026-09-11 | Codex | Recorded the PRD-066 Phase 0 retrieval-only reuse tranche (`forge author reuse`, verbatim span-exact candidates, no model or network) as implemented in PR #153 (merged, `7d0d9f3`; see 1.8); PRD-066 stays Planned and its usefulness, rubric, privacy/legal and release gates stay open. |
| 1.9 | 2026-09-12 | Codex | Recorded the PRD-066 Phase 1 local-only `forge suggest` pipeline as implemented, now merged in PR #155 (merge `f09a299`): nine closed contracts, the owner's local-only/corpus-first decisions, and GATE-SUGGEST rows whose usefulness and release gates stay open. PRD-066 stays Planned. |
...
| 1.10 | 2026-09-12 | Codex | Post-merge reconciliation: recorded the PR #155 merge (`f09a299`) across the roadmaps, gates, PRD-066 and this changelog; added `tests/suggest_adversarial_test.rs` (prompt injection quoted-verbatim-or-refused, network-symbol source scan) and corrected the verification-matrix M-6/M-17 rows. Usefulness, M-14/M-15 and release gates stay open. |
