...
| [066](docs/PRD/066-prd-ai-assisted-suggestions.md) | AI-assisted suggestions | Planned — Phase 0 retrieval tranche merged, quarantine pipeline in progress | Phase 0 retrieval-only `forge author reuse` merged in PR #153 (merge `7d0d9f3`; [reuse plan](docs/plans/2026-09-11-066-mvp-reuse-plan.md), [gate register](docs/authoring-gates.md#gate-reuse--prd-066-phase-0-reuse-tranche)); remaining work is local-only and offline per the owner's 2026-09-12 decisions ([suggestions plan](docs/plans/2026-09-12-066-suggestions-pipeline.md)); adjudicated corpora, M-14/M-15 thresholds, usefulness and release gates remain open |
