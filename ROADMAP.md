...
- **2 in progress:** PRD 061 Phase 1 technical foundation and PRD 062's local
...
| [061](docs/PRD/061-prd-framework-guided-policy-authoring.md) | Framework-guided policy authoring | In Progress — Phase 1 | [Implementation plan](docs/authoring-phase1-plan.md), local authoring contracts and CLI work; M-13 impact and PRD-059 composition remain Phase 2; human readiness, pilot, and release gates remain pending |
...
| **Now** | PRD 061 Phase 1 | Deliver a traceable drafting-plan and skeleton technical foundation; preserve pending product, compliance, legal, design-partner, and release gates |
