...
- **2 in progress:** PRD 061 Phase 2 technical extension and PRD 062's local
...
| [061](docs/PRD/061-prd-framework-guided-policy-authoring.md) | Framework-guided policy authoring | In Progress — Phase 2 | Phase 1 merged in PR #144; [Phase 2 interface and acceptance matrix](docs/authoring-phase2-plan.md) covers components, M-13, HTML and draft handoff; human readiness, pilot and release gates remain pending |
...
| **Now** | PRD 061 Phase 2 | Validate explicit components, M-13 dependency impact, offline HTML and draft lifecycle handoff; preserve pending product, compliance, legal, design-partner, and release gates |
