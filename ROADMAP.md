...
- **2 in progress:** PRD 061, whose Phase 1 and Phase 2 technical phases are merged
  (PR #144 and PR #145) with human gates pending, and PRD 062's local
...
| [061](docs/PRD/061-prd-framework-guided-policy-authoring.md) | Framework-guided policy authoring | Technical phases merged — human gates pending | Phase 1 merged in PR #144; Phase 2 merged in PR #145 (merge `3ac6815`; commits `fedf29e`, `18fa937`, `7901148`). [Phase 2 interface and acceptance matrix](docs/authoring-phase2-plan.md), [contracts](docs/authoring-phase2.md) and [evidence map](docs/authoring-phase2-evidence.md) cover components, M-13, HTML, draft handoff and the S-1 scaffold; public Rust API/semver, product, compliance, legal/content, design-partner, human readiness, pilot and release gates remain pending |
...
| **Now** | PRD 061 closeout | Reconcile the merged Phase 1/Phase 2 technical evidence, S-1 scaffold and S-4 disposition, then complete the pending public Rust API/semver, product, compliance, legal/content, design-partner, readiness, pilot and release gates |
