...
| [061](docs/PRD/061-prd-framework-guided-policy-authoring.md) | Framework-guided policy authoring | In Progress — Phase 2 (PR #145 under review) | Phase 1 merged in PR #144 ([Phase 1 plan](docs/authoring-phase1-plan.md)); [Phase 2 interface and acceptance matrix](docs/authoring-phase2-plan.md) covers components, M-13, HTML and draft handoff; public Rust API/semver review, legal/content, design-partner, human readiness, pilot and release gates remain pending |
