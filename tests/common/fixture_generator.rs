...
session termination after thirty minutes of inactivity.",
                requirements: &[
                    ...
                    "Authentication credentials shall be transmitted only over encrypted channels using Transport Layer Security version 1.2 or higher in compliance with RFC 5246.",
...
algorithms shall be removed from organizational systems within ninety days of deprecation notification.",
                requirements: &[
                    ...
                    "Data in transit shall be protected using Transport Layer Security version 1.2 or higher and must use cipher suites approved by the organization in compliance with RFC 5246.",
...
when performed by external service providers.",
                requirements: &[
                    ...
                    "Equipment maintenance shall be performed by authorized personnel only and must be supervised when performed by external service providers. See Section 7.1 for personnel clearance requirements.",
