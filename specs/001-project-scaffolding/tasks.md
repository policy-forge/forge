...
- [x] T004 [P] Create `.rustfmt.toml` with project formatting configuration (edition = "2021", max_width = 100, use_small_heuristics = "Max", imports_granularity = "Module", group_imports = "StdExternalCrate")
