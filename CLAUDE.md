...
- Rust, Edition 2024, stable 1.93.0 + clap 4.x (CLI), serde 1.0.228, serde_json 1.0.149, chrono 0.4, thiserror 2.0.18, tracing 0.1.44 — all already in Cargo.toml. **No new dependencies.** (038-traceability-report)
