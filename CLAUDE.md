...
## Active Technologies
- Rust, Edition 2024, stable 1.93.0 + `serde_json` 1.0.149, `quick-xml` 0.37, `serde_yaml_ng` 0.10 (028-round-trip-testing)
- N/A — test-only code operating on in-memory models and fixture files (028-round-trip-testing)
